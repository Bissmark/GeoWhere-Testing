    ...
    return (
        <div className="bg-fixed text-center text-yellow-500 pb-5">
            ...
            <div className="bg-slate-800 rounded-lg p-8 m-5">
                <img className="mx-auto mb-5" src="https://www.geoguessr.com/_next/static/images/onboarding-1-2x-58eaef4035cf1e4155cdbd187a530895.png" alt="globe picture" />
            ...
            <div className="bg-slate-800 rounded-lg p-8 m-5">
                <img className="mx-auto" src="https://www.geoguessr.com/_next/static/images/onboarding-3-2x-95a89d5b0cb37f58ee54bf5a165986bd.png" alt="messege" />
